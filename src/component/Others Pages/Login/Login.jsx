            ...
            <form onSubmit={handleSignIn}>
                <div className='form py-20 px-96'>
                    <div className='bg-white rounded-lg'>
                        ...
                        <input className='mt-5 px-1 md:px-10 py-3 rounded-lg block mx-auto button text-white cursor-pointer' type="submit" value="Login" />
                        ...
                        <div className='flex gap-3 items-center border-2 border-black mx-1 md:mx-40 md:px-32 px-3 py-3 rounded-lg mb-3 cursor-pointer othersLogin'>
